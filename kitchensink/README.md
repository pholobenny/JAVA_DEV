kitchensink: Example Application Using Multiple HTML5, Mobile & JAX-RS Technologies 
=========================================================================================================
Author: Jay Balunas
Level: Beginner 
...
The client application will be running at the following URL <http://localhost:8080/kitchensink/>.
